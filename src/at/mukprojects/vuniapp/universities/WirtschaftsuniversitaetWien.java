...
import at.mukprojects.vuniapp.dao.CertificateDAOWebLPIS;
import at.mukprojects.vuniapp.dao.HtmlDataDAOCache;
import at.mukprojects.vuniapp.dao.HtmlDataDAOWebWUWien;
...
import at.mukprojects.vuniapp.dao.SubjectDAOWebLPIS;
...
import at.mukprojects.vuniapp.services.ProfessorServiceWUWienCaching;
...
/**
 * Die Klasse kapselt alle Funktionen f&uuml;r die Wirtschaftsuniversit&auml;t
 * Wien.
 * 
 * @author Mathias
 * @author kerrim
 */
public class WirtschaftsuniversitaetWien extends University implements
        CompleteUniversityInterfaces {
    private static final long        serialVersionUID = 1L;

    /** Name der Universit&auml;t. */
    public static final String       NAME             = "Wirtschaftsuniversität Wien";
    public static final String       KEY              = "wuwien";

    private static final String      TAG              = WirtschaftsuniversitaetWien.class
                                                              .getSimpleName();
    ...
    /**
     * Erstellt ein WirtschaftsuniversitaetWien Object.
     */
    public WirtschaftsuniversitaetWien() {
        super(NAME, KEY);

        canteenList = new HashMap<String, Integer>();
        canteenList.put("WU Wien MensaMarkt & M-Cafes UZA1", 22);
    ...
    public final ArrayList<Professor> searchProfessor(final String input)
        ...
        ProfessorService service = new ProfessorServiceWUWienCaching(
                new ProfessorDAOWebWUWien(this),
                new ProfessorDAOWebWUWienCache());
    ...
    public final ArrayList<Subject> getSubjects(
        ...
        SubjectService service = new SubjectServiceCachingFiltered(
                new SubjectDAOWebLPIS(user, this), new SubjectDAOCache(KEY),
    ...
    public final Subject getSubjectDetails(
        ...
        if (subject.getLink() != null) {
            UniversityUser user = users.get(UKZID);
            SubjectService service = new SubjectServiceCachingFiltered(
                    new SubjectDAOWebLPIS(user, this),
    ...
    public final ArrayList<Certificate> getCertificates(
        ...
        CertificateService service = new CertificateServiceCaching(
                new CertificateDAOWebLPIS(user, this), new CertificateDAOCache(
                        KEY));
    ...
    public final boolean checkLoginData(final UniversityUser user)
            throws IOException {
        DAOWebLPIS dwl = new DAOWebLPIS(user, this);
        return dwl.validLogin();
    ...
    public final HtmlData getUniversityDates() throws IOException {
        ...
        String datesUrl = "http://www.wu.ac.at/students/org/calendar/year";

        HtmlDataService service = new HtmlDataServiceCaching(
                new HtmlDataDAOWebWUWien(), new HtmlDataDAOCache());
