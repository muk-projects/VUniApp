...
import at.mukprojects.vuniapp.dao.CertificateDAOWebUNIVIS;
import at.mukprojects.vuniapp.dao.HtmlDataDAOCache;
import at.mukprojects.vuniapp.dao.HtmlDataDAOWebStudentPointUniWien;
import at.mukprojects.vuniapp.dao.ProfessorDAOWebUniWien;
...
import at.mukprojects.vuniapp.dao.SubjectDAOWebMOODLE;
...
import at.mukprojects.vuniapp.services.SubjectServiceCaching;
...
/**
 * Die Klasse kapselt alle Funktionen f&uuml;r die Universit&auml;t Wien.
 * 
 * @author Mathias
 * @author kerrim
 */
public class UniversitaetWien extends University implements
        CompleteUniversityInterfaces {
    private static final long        serialVersionUID = 1L;

    /** Name der Universit&auml;t. */
    public static final String       NAME             = "Universität Wien";
    public static final String       KEY              = "uniwien";

    private static final String      TAG              = UniversitaetWien.class
                                                              .getSimpleName();
    ...
    /**
     * Erstellt ein UniversitaetWien Object.
     */
    public UniversitaetWien() {
        super(NAME, KEY);

        canteenList = new HashMap<String, Integer>();
        canteenList.put("Uni Wien Mensa & M-Cafe NIG", 5);
        canteenList.put("Uni Wien M-Cafe im Juridicum", 17);
    ...
    public final ArrayList<Professor> searchProfessor(final String input)
        ...
        ProfessorService service = new ProfessorServiceStd(
                new ProfessorDAOWebUniWien(this));
    ...
    public final ArrayList<Subject> getSubjects(
        ...
        SubjectService service = new SubjectServiceCachingFiltered(
                new SubjectDAOWebMOODLE(user, this), new SubjectDAOCache(KEY),
    ...
    public final Subject getSubjectDetails(
        ...
        if (subject.getLink() != null) {
            UniversityUser user = users.get(UKZID);
            SubjectService service = new SubjectServiceCachingFiltered(
                    new SubjectDAOWebMOODLE(user, this), new SubjectDAOCache(
                            KEY), new SubjectDAOFilterDB(context));
    ...
    public final ArrayList<Certificate> getCertificates(
        ...
        CertificateService service = new CertificateServiceCaching(
                new CertificateDAOWebUNIVIS(user, this),
                new CertificateDAOCache(KEY));
    ...
    public final boolean checkLoginData(final UniversityUser user)
            throws IOException {
        DAOWebUNIVIS dwu = new DAOWebUNIVIS(user, this);
        return dwu.validLogin();
    }
    ...
    public final HtmlData getUniversityDates() throws IOException {
        ...
        String datesUrl = "http://studentpoint.univie.ac.at/durchs-studium/termine-fristen-ferien/";

        HtmlDataService service = new HtmlDataServiceCaching(
                new HtmlDataDAOWebStudentPointUniWien(), new HtmlDataDAOCache());
