...
/**
 * DAO zum Holen von HTML Daten aus der <a href="http://www.wu.ac.at">WU
 * Wien</a> Seite.
 * 
 * @author kerrim
 */
public class HtmlDataDAOWebWUWien extends DAOWeb implements HtmlDataDAO {
    private static final String TAG = HtmlDataDAOWebWUWien.class
                                            .getSimpleName();
    ...
    public final HtmlData readHtmlData(final String url) throws IOException {
        ...
        Pattern contentStart = Pattern.compile(".*<!-- content -->");
        Pattern contentEnd = Pattern.compile(".*<div id=\"bd-left-nav\".*");
