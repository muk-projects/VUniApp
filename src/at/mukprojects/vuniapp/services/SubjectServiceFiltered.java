 ...
 * @author kerrim
 */
public class SubjectServiceFiltered implements SubjectService {
    private static final String TAG = SubjectServiceFiltered.class
                                            .getSimpleName();
     ...
     */
    public SubjectServiceFiltered(final SubjectDAO subjectDAO, final SubjectDAO filter) {
        Log.i(TAG, "Methode: Konstruktor wird gestartet.");
        subjectService = new SubjectServiceStd(subjectDAO);
        this.filter = filter;
