...
/**
 * Die Exception wenn ein Singelton nicht geladen werden kann, da eine
 * Inizialisierung fehlt.
 * 
 * @author Mathias
 */
public class NotInitializedException extends BaseException {
     ...
     */
    private static final String MESSAGE          = "Das Singelton wurde nicht"
                                                         + " korrekt inizialisiert.";

    /**
     * Erstellt eine neue NotInitializedException.
     */
     ...
     */
    public NotInitializedException(final String detailMessage) {
     ...
     */
    public NotInitializedException(final boolean critical) {
