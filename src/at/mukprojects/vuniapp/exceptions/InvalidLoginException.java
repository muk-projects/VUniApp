...
public class InvalidLoginException extends BaseException {
     ...
     */
    private static final String MESSAGE          = "Anmeldung mit Benutzernamen und"
                                                         + " Passwort fehlgeschlagen.";

    /**
     * Erstellt eine neue InvalidLoginException.
     */
     ...
     */
    public InvalidLoginException(final String detailMessage) {
     ...
     */
    public InvalidLoginException(final boolean critical) {
