...
/**
 * Die Exception wird geworfen, wenn eine Funktion einer TwoPane Activity
 * verwendet wird, jedoch der aktulle Status keine TwoPane Activity ist.
 * 
 * @author Mathias
 */
public class NoTwoPaneException extends BaseException {
     ...
     */
    private static final String MESSAGE          = "Es handelt sich nicht um"
                                                         + " eine TwoPane Activity";

    /**
     * Erstellt eine neue NoTwoPaneException.
     */
    public NoTwoPaneException() {
        super(MESSAGE);
    }
     ...
     */
    public NoTwoPaneException(final String detailMessage) {
     ...
     */
    public NoTwoPaneException(final boolean critical) {
     ...
     *            Gibt an, ob es sich um einen fatalen Fehler handelt.
     */
    public NoTwoPaneException(final String detailMessage, final boolean critical) {
